...
export const BurgerMenu = ({ onClose }) => {
    return (
        <div className="w-[406px] mt-[37px] flex justify-around h-[100vh] bg-white">
            <div className="fixed lg:left-0 bg-white top-0 pt-[36px] z-50 h-full w-full p-4">
                <div className="flex justify-between items-baseline mb-[65px]">
                    ...
                    <svg
                        ...
                        onClick={onClose}
                        viewBox="0 0 24 24"
                        className="right-12 hidden lg:block"
                        width="36"
                        height="36"
                        fill="none"
                        stroke="#000000"
